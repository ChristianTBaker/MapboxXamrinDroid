...
namespace Com.Mapbox.Android.Telemetry.Location {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.mapbox.android.telemetry.location']/class[@name='LocationUpdatesBroadcastReceiver']"
	[global::Android.Runtime.Register ("com/mapbox/android/telemetry/location/LocationUpdatesBroadcastReceiver", DoNotGenerateAcw=true)]
	public partial class LocationUpdatesBroadcastReceiver : global::Android.Content.BroadcastReceiver {

		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/mapbox/android/telemetry/location/LocationUpdatesBroadcastReceiver", typeof (LocationUpdatesBroadcastReceiver));
		...
		protected LocationUpdatesBroadcastReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.mapbox.android.telemetry.location']/class[@name='LocationUpdatesBroadcastReceiver']/constructor[@name='LocationUpdatesBroadcastReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe LocationUpdatesBroadcastReceiver ()
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.mapbox.android.telemetry.location']/class[@name='LocationUpdatesBroadcastReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
