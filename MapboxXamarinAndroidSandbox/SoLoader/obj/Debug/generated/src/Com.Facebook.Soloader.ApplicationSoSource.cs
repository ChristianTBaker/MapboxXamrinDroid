...
namespace Com.Facebook.Soloader {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.facebook.soloader']/class[@name='ApplicationSoSource']"
	[global::Android.Runtime.Register ("com/facebook/soloader/ApplicationSoSource", DoNotGenerateAcw=true)]
	public partial class ApplicationSoSource : global::Com.Facebook.Soloader.SoSource {

		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/facebook/soloader/ApplicationSoSource", typeof (ApplicationSoSource));
		...
		protected ApplicationSoSource (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.facebook.soloader']/class[@name='ApplicationSoSource']/constructor[@name='ApplicationSoSource' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='int']]"
		[Register (".ctor", "(Landroid/content/Context;I)V", "")]
		public unsafe ApplicationSoSource (global::Android.Content.Context context, int flags)
		...
		static Delegate cb_checkAndMaybeUpdate;
#pragma warning disable 0169
		static Delegate GetCheckAndMaybeUpdateHandler ()
		{
			if (cb_checkAndMaybeUpdate == null)
				cb_checkAndMaybeUpdate = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, bool>) n_CheckAndMaybeUpdate);
			return cb_checkAndMaybeUpdate;
		}

		static bool n_CheckAndMaybeUpdate (IntPtr jnienv, IntPtr native__this)
		{
			global::Com.Facebook.Soloader.ApplicationSoSource __this = global::Java.Lang.Object.GetObject<global::Com.Facebook.Soloader.ApplicationSoSource> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.CheckAndMaybeUpdate ();
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='com.facebook.soloader']/class[@name='ApplicationSoSource']/method[@name='checkAndMaybeUpdate' and count(parameter)=0]"
		[Register ("checkAndMaybeUpdate", "()Z", "GetCheckAndMaybeUpdateHandler")]
		public virtual unsafe bool CheckAndMaybeUpdate ()
		{
			const string __id = "checkAndMaybeUpdate.()Z";
			try {
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.facebook.soloader']/class[@name='ApplicationSoSource']/method[@name='loadLibrary' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='int'] and parameter[3][@type='android.os.StrictMode.ThreadPolicy']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.facebook.soloader']/class[@name='ApplicationSoSource']/method[@name='unpackLibrary' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
